<template>
  <div class="mt-4 mb-4">
    ...
    ></app-search>
    <modal name="location">
      <app-location @onSelectLocation="query.location = $event; $modal.hide('location');"></app-location>
    </modal>
    <modal name="category">
      <app-category
        :query="query"
        @onSelectCategory="query.category = $event; $modal.hide('category');"
      ></app-category>
    </modal>
    <!-- <hr> -->
    ...
    getProducts(page, query) {
      ...
      productController
        ...
        .then((result) => {
          ...
          this.currentLocation = this.query.location
            ? this.query.location
            : 'All over the world';
          this.currentCategory = this.query.category
            ? this.query.category
            : 'All Catrgories';
